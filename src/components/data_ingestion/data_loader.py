...
class Data_Getter:
    ...
    # This class is used for getting data from the source for Training
    def __init__(self,file_object,logger_object):
        self.training_file=r"src\Training_FileFromDB\InputFile.csv"
        self.file_object=file_object
        self.logger_object=logger_object


    def get_data(self):
        # This method will read data from the csv file to Dataframe
